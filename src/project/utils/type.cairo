...
func _check_uint_fits_felt{range_check_ptr}(value: Uint256) {
...
func _uint_to_felt{range_check_ptr}(value: Uint256) -> (value: felt) {
    uint256_check(value);
...
func _felt_to_uint{range_check_ptr}(value: felt) -> (value: Uint256) {
